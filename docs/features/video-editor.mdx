...
The Video Editor is the central workspace in ACT3 AI where you assemble your production into a finished video. It combines a multi-track timeline, storyboard visualization, script view, preview playback, and render management in a single unified environment.
...
**Storyboard Pane** — Visualize storyboard panels for each shot. Use alongside the timeline for visual continuity checking.
...
The Storyboard Pane shows visual panels for each shot linked to timeline positions. Use it to:

- Check visual flow and continuity before rendering
- Verify that action matches between consecutive shots
- Add, remove, or reorder shots while seeing the visual context
- Export storyboards as PDFs for client review
...
3. Choose output settings (see [Export](/docs/export/overview) for full details)
4. Monitor progress in the [Render Queue](/docs/features/render-queue)

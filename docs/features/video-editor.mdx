...
**Top-Down View** — Place actors, cameras, and props in a bird's-eye layout for [scene blocking](/how-to/block-a-scene).

## The Timeline

The Timeline is the core editing surface. Use [Trimming](/features/trimming) to shorten individual shots to remove dead space. The [Shot List](/features/shot-list) provides a structured management view of all shots alongside the timeline. Key features:
...
7. Apply color grading for [visual consistency](/how-to/review-visual-consistency)
...
The [Background Audio](/features/background-audio) track layer lets you control ambient sound separately from dialogue — enabling clean audio post-production handoffs and precise scene ambience control.
...
Use the [AI Chat window](/features/ai-chat) to make changes to shots, scenes, and the whole project through natural language instructions without navigating menus.

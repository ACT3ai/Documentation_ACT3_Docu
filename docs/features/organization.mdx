...
See [Credits](/account/credits) and [Billing](/account/billing) for detailed pricing and payment management. See [Projects](/concepts/projects) for details on how Projects are structured within an Organization.

...
See [Credits](/account/credits) and [Billing](/account/billing) for detailed pricing and payment management. See [Projects](/concepts/projects) for details on how Projects are structured within an Organization. Organization-level configuration is managed in [Organization Settings](/account/settings-organization).
...
- **Actor Library** — [Digital actors](/features/actors) created in any project are accessible from every project in the organization
- **Set Templates** — Saved [set](/features/sets) designs can be reused across multiple productions
- **[Style Presets](/features/style-presets)** — Visual look presets (lighting, color grade, mood) shared across projects

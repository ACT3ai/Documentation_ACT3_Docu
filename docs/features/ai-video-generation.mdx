...
ACT3 AI transforms your [scripts](/features/script-editing), [scenes](/concepts/scenes), and [shot](/concepts/shots) prompts into video clips using a suite of AI rendering engines. You choose the engine that fits your style and quality requirements, then direct the output using natural language [cinematography](/features/cinematography) instructions.

## How It Works

The generative pipeline connects your creative decisions to AI rendering in a continuous loop:

1. **Script → Structure** — Your script is broken into [acts](/concepts/acts), [scenes](/concepts/scenes), [beats](/concepts/beats), and shots
2. **Shot Prompts** — Each shot has a text description with camera angle, movement, mood, and subject
3. **Engine Selection** — Choose from [Google Veo 3.1](/integrations/veo3), [Grok Video](/integrations/grok-video), or [Wan 2.1](/integrations/wan)
...
[Render Styles](/features/render-styles) define the overall visual aesthetic — color grading, film grain, contrast, and mood — applied at render time to give your entire project a unified cinematic look.
...
3. **Characters and Casting** — Define characters and assign [digital actors](/features/actors)
4. **Visual Planning** — Top-Down View and [set design](/features/sets)
5. **Generative Rendering** — Generate draft previews for each shot
6. **Assembly and Editing** — Combine clips, B-roll, and audio in the [timeline](/features/video-editor)

...
Style Presets let you apply predefined or custom visual styles across [scenes](/concepts/scenes), [shots](/concepts/shots), and entire [projects](/concepts/projects). Presets ensure consistency in tone, color, and atmosphere — whether you are creating cinematic films, marketing ads, or social media videos.

...
The Story Arc system is ACT3 AI's narrative planning and management tool. It gives you a dedicated space to develop the structural shape of your story — independent of the line-by-line [script](/features/script-editing), but directly connected to it. When you edit [scenes](/concepts/scenes) or [shots](/concepts/shots) in the Editor, Story Arc panels update to reflect your position in the narrative timeline, keeping the big picture visible while you work on individual moments.
...
Story layers are informational planning tools — they do not directly generate [shots](/concepts/shots). They shape the AI's understanding of the story when you run AI generation tasks.

...
- Color coding distinguishes [acts](/concepts/acts), [scenes](/concepts/scenes), and [shots](/concepts/shots) at a glance — see [story structure](/how-to/build-story-structure) to understand how these relate
...
2. Choose your file type: [Final Draft](/how-to/import-a-script) (FDX), plain text (TXT), or Markdown

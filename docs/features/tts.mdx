...
ACT3 AI uses **Azure Neural TTS** for voice generation. Azure Neural TTS provides natural-sounding voices across dozens of languages and accents. The generated audio is used for character dialogue and drives both the [lip sync](/features/lipsync) duration and NVIDIA Audio2Face facial animation.

...
ACT3 AI gives you full [cinematography](/filmmakers/cinematography) control through written instructions that direct AI rendering engines. From camera angles and [camera movement](/how-to/set-camera-movement) to lenses, depth of field, and [visual style](/how-to/set-visual-style), you define the cinematic language of your project [shot](/concepts/shots) by shot.
...
Use the [Top-Down View](/how-to/top-down-set-editor) to plan camera positions and [blocking](/how-to/block-a-scene) before generating video with [AI Video Generation](/features/ai-video-generation):

...
ACT3 AI gives you full cinematography control through written instructions that direct AI rendering engines. From camera angles and movement to lenses, depth of field, and visual style, you define the cinematic language of your project shot by shot.
...
Use the Top-Down View to plan camera positions before generating video:
...
5. Sync adjustments to the Timeline and Storyboard before generating
...
- [Style Presets](/docs/features/style-presets)

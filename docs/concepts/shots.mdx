...
Use the [Render Queue](/how-to/manage-render-queue) to batch-render multiple shots at once and monitor progress. Apply [Render Styles](/features/render-styles) for a consistent visual look across all generated clips.
...
- View all shots in [Top-Down View](/how-to/top-down-set-editor) to verify camera placement and [blocking](/how-to/block-a-scene)
- Lock [approved shots](/how-to/review-and-approve-shots) to prevent accidental changes

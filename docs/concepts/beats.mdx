...
4. Inside each beat you define one or more [Shots](/concepts/shots), setting up [camera movement](/how-to/set-camera-movement) and [blocking](/how-to/block-a-scene) for each angle
...
Use the [Story Arc](/features/story-arc) system to visualize and plan beat patterns across the full production timeline.

...
To keep actors and sets consistent across episodes: [digital actors](/features/actors) and [sets](/features/sets) are defined at the series level and are available in every episode. Apply the same [Style Preset](/features/style-presets) to the entire series to lock in a consistent visual look across all episodes.

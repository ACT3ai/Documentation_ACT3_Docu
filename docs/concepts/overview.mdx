...
ACT3 AI organizes every project using the same hierarchy that professional filmmakers and writers use: [Beats](/concepts/beats), [Acts](/concepts/acts), [Scenes](/concepts/scenes), and [Shots](/concepts/shots). Understanding this structure helps you move from a rough idea to a fully produced video efficiently. See [Projects](/concepts/projects) for how productions are organized at the top level.
...
To keep actors and sets consistent across episodes: [digital actors](/features/actors) and [sets](/features/sets) are defined at the series level and are available in every episode. Apply the same [Style Preset](/features/style-presets) to the entire series to lock in [visual consistency](/how-to/review-visual-consistency) across all episodes.

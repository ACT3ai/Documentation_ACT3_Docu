...
ACT3 AI organizes every project using the same hierarchy that professional filmmakers and writers use: [Beats](/concepts/beats), [Acts](/concepts/acts), [Scenes](/concepts/scenes), and [Shots](/concepts/shots). Understanding this structure helps you move from a rough idea to a fully produced video efficiently.
...
To keep actors and sets consistent across episodes: actors and sets are defined at the series level and are available in every episode. Apply the same [Style Preset](/features/style-presets) to the entire series to lock in a consistent visual look across all episodes.

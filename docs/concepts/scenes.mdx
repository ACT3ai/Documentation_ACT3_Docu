...
You can generate video previews for an entire scene at once, or render individual shots within a scene. Scene-level rendering sends all shots in sequence to the [render queue](/features/render-queue), producing a continuous clip for review.

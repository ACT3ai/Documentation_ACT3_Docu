...
1. Open your Organization from the top navigation
2. Click **New Project**
3. Enter a title
4. Select format, aspect ratio, and target duration
5. Optionally apply a [Style Preset](/features/style-presets) for visual consistency
6. Click **Create Project**

The Project opens to the Script view. From here you can paste in an existing script or begin writing one.

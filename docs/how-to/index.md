...
description: Step-by-step task guides for getting specific things done in ACT3 AI.
---
...
- Importing a script
- Creating a project from a story idea
- Setting up a virtual set
- Adding and blocking characters
- Generating a shot
- Adjusting camera angles and lighting
- Regenerating a shot with different settings
- Exporting for YouTube, TikTok, or festival submission

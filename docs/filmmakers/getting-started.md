---
id: filmmakers-getting-started
slug: getting-started
title: Getting Started for Filmmakers
sidebar_label: Getting Started
description: How to bring your existing film workflow into ACT3 AI — starting with your script.
---
...
→ See [How to use the script editor](/how-to/use-the-script-editor)
...
- [Director](/filmmakers/director) — overall vision, pacing, approving AI output
- [Cinematographer](/filmmakers/cinematography) — camera angles, lenses, movement, lighting
- [Set Designer](/filmmakers/set-design) — virtual locations and environments
- [Casting Director](/filmmakers/casting-director) — creating and managing digital actors
- [Screenwriter](/filmmakers/screenwriting) — writing, revising, AI-assisted story development
- [Costume Designer](/filmmakers/costume-design) — character wardrobe and visual consistency

---
id: filmmakers-video-editing
title: Video Editing
sidebar_label: Video Editing
description: How to assemble, cut, and export your film in ACT3 AI — from shot review to final deliverable.
---
...
→ [How to review shots in the timeline](/docs/how-to/review-shots-in-timeline)
...
→ [How to adjust shot timing](/docs/how-to/adjust-shot-timing)
...
→ [How to assemble a scene](/docs/how-to/assemble-scene)
...
→ [How to edit dialogue audio](/docs/how-to/edit-dialogue-audio)
...
→ [How to export for post-production](/docs/how-to/export-for-delivery)
...
→ [How to export for social platforms](/docs/how-to/export-for-platforms)

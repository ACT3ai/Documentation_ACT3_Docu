---
id: filmmakers-cinematography
title: Cinematography
sidebar_label: Cinematography
description: How to handle cinematography in ACT3 AI — shot types, camera movement, lenses, and lighting.
---
...
→ [How to place a camera in the top-down editor](/docs/how-to/place-camera-top-down)
...
→ [How to plan coverage for a scene](/docs/how-to/plan-scene-coverage)
...
→ [How to set lens and depth of field](/docs/how-to/set-lens)

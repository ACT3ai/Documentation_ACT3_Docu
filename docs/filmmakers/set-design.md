---
id: filmmakers-set-design
slug: set-design
title: Set Design
sidebar_label: Set Design
description: How to create, find, and manage virtual sets and locations in ACT3 AI.
---
...
→ [How to browse and assign a set](/how-to/browse-and-assign-set)
...
→ [How to create a set from a description](/how-to/create-a-set)
...
→ [How to add props to a set](/how-to/add-props-to-set)

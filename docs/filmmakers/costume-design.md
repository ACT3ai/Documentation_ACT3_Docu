---
id: filmmakers-costume-design
slug: costume-design
title: Costume Design
sidebar_label: Costume Design
description: How to design, assign, and manage character wardrobe in ACT3 AI.
---
...
→ [How to define a character's costume](/how-to/define-character-costume)
...
→ [How to use a costume reference image](/how-to/costume-reference-image)
...
→ [How to set a per-scene costume](/how-to/per-scene-costume)
...
→ [How to check wardrobe continuity](/how-to/check-actor-consistency)
...
→ [How to write effective costume descriptions](/how-to/write-costume-descriptions)
...
→ [How to add costume detail notes to a shot](/how-to/shot-costume-detail)

...
- Shared [Digital Actors](/features/actors) and character library — [create a digital actor](/how-to/create-digital-actor) to add one
...
If your team needs additional seats beyond your current plan, upgrade from **Settings → Plans and Billing**. See [Organization Settings](/account/settings-organization) for all organization-level configuration options.

## Collaboration Features

Team members can work on the same project simultaneously. Key collaboration features include:

- **Real-time co-editing** — Multiple editors see each other's changes in the Editor and [Script Editor](/how-to/use-the-script-editor) as they happen

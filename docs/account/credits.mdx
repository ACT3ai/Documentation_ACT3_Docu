...
- **Engine** — Premium AI engines ([Google Veo 3.1](/integrations/veo3), Seedance 2.0 at 1080p or 4K) cost more than fast / draft engines ([Grok Imagine](/integrations/grok-video), Veo 3.1 Fast, Seedance 2.0 Fast, Seedance 2.0 Mini, [Wan 2.6](/integrations/wan))
- **Duration** — Credits scale with the length of each shot. Each shot is generated at its own planned duration (or its trimmed / previously-generated length if you've edited it). Each AI model has its own allowed durations — Veo 3.1: 4, 6, or 8 sec; Seedance 2.0: 4–15 sec; Seedance 2.5: 4–30 sec; Wan 2.6: 5, 10, or 15 sec; Grok: 1–15 sec — and snaps to the nearest. Final render fees scale with the total length of generated footage.
...
To compare how many credits each subscription tier includes, see [Pricing Details](/account/pricing-details).
...
|---|---|---|
| Seedance 2.0 Mini | 720p | 157 |
| Grok Imagine | 720p | 364 |
| Seedance 2.0 Fast | 720p | 472 |
| Seedance 2.5 | 480p | 535 |
| Wan 2.6 | 1080p | 780 |
| Veo 3.1 Fast | 720p | 780 |
| Veo 3.1 Fast | 1080p | 780 |
| Seedance 2.5 | 720p | 1,202 |
| Seedance 2.0 | 1080p | 1,946 |
| Veo 3.1 | 1080p | 2,080 |
| Seedance 2.5 | 1080p | 2,128 |
| Seedance 2.0 | 4K | 4,044 |
...
**Use Fast / cheaper models for early-stage iteration** — Seedance 2.0 Mini (157 cr), Grok Imagine (364 cr) and Seedance 2.0 Fast (472 cr) cost roughly 4–13× less per 8-second shot than Veo 3.1 standard (2,080 cr) or Seedance 2.0 at 1080p (1,946 cr). Iterate creative direction on the cheap engines first, then commit hero shots to the premium models.

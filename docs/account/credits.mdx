...
- **Engine** — Premium AI engines (Google Veo 3.1, Hunyuan) cost more than preview engines (Wan 2.1)
...
- Generate 3–5 Wan 2.1 preview variations to find the right creative direction before using Google Veo 3.1 or Hunyuan

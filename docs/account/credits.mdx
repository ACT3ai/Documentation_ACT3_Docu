...
- **Duration** — Every video clip is generated as **8 seconds** by default; credits scale with that duration. Final render fees scale with the total length of generated footage.
...
|---|---|
| Generate Plot | 13 |
| Generate Character Overview | 14 |
| Generate Act | 11 |
| Generate Beat | 22 |
| Generate Scene | 39 |
| Generate Shot | 60 |
| Generate Shot Depth | 34 |
| Generate Shot Script | 1 |
| Generate Mega Prompt YAML | 9 |

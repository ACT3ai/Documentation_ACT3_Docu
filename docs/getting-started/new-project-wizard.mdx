...
The Plot Wizard turns a rough idea into a fully structured story. You provide a concept — a single sentence, a paragraph, a genre, a theme — and ACT3 AI builds a complete story architecture around it: [acts](/concepts/acts), [scenes](/concepts/scenes), character arcs, key dramatic [beats](/concepts/beats), and a scene-by-scene outline. The result is a project that is production-ready, with a stronger plot structure than most writers can produce alone in a first pass.
...
- **Key beats** — the 8–15 most important dramatic moments in the story (see [story structure](/how-to/build-story-structure))

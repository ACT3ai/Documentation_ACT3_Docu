...
Type directly in the built-in [script editor](/features/script-editing). It auto-formats scene headings (INT./EXT.), character names, and dialogue blocks as you type.

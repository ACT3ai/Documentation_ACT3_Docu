...
- You have a finished or draft screenplay in [Final Draft](/how-to/import-a-script), PDF, plain text, or Markdown
...
**Characters** — In the Actor Library, create or assign [digital actors](/features/actors) to each imported character name. See [cast actor in scene](/how-to/cast-actor-in-scene) for the full casting workflow.

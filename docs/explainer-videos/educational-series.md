---
id: explainer-educational-series
title: Educational Video Series
sidebar_label: Educational Series
slug: educational-series
description: How to produce a multi-part educational video series in ACT3 AI.
---
...
→ [How to build story structure](/how-to/build-story-structure)
...
→ [How to assign a character voice](/how-to/assign-character-voice)
→ [How to set voice delivery](/how-to/set-voice-delivery)
...
→ [How to review and approve shots](/how-to/review-and-approve-shots)
...
→ [How to export for platforms](/how-to/export-for-platforms)

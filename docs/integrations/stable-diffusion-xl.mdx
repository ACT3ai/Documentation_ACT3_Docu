...
description: How to use Stable Diffusion XL in ACT3 AI for storyboard panels, concept art, and set imagery.
---

# Stable Diffusion XL

The Stable Diffusion XL (SDXL) integration in ACT3 AI enables high-quality image generation for storyboard panels, set backgrounds, concept art, and character reference imagery. SDXL is an image model rather than a video model — it produces static visuals that you use for planning, previsualization, and as inputs to video generation tools like Flux.
...
- Storyboard panels for visual shot planning
...
1. In the Editor or Storyboard Panels view, click **AI → Stable Diffusion XL**
...
6. Use accepted images as storyboard panels, set backgrounds, or concept references
...
- **Storyboards** — Generate panels quickly before committing to video renders
...
- Generate storyboard panels with SDXL, then animate them with **Flux Image-to-Video**
...
- Generate 3–5 variations per key shot and choose the best as a storyboard reference
...
- [Blender](/docs/integrations/blender)

...
2. Enter your shot prompt or select a storyboard panel
...
6. When you find a direction that works, use that prompt with Google Veo 3 or Runway for final quality
...
- Much lower than Google Veo 3 or Hunyuan at equivalent duration
...
3. **Final render** — Submit approved prompts to Google Veo 3, Runway, Flux, or Hunyuan for high-quality output
...
**Quality lower than expected** — Wan 2.1 is intentionally lower quality for speed. Use Google Veo 3 or Hunyuan for final-quality output.

...
title: Flux
sidebar_label: Flux
description: How to use FLUX in ACT3 AI for high-quality image generation, storyboard panels, and Image-to-Video workflows.
---
...
Flux's Image-to-Video mode is ideal for animating concept art, storyboard panels, or SDXL-generated still images:
...
This is particularly effective for giving SDXL-generated storyboard panels a motion preview.
...
- Adding motion to storyboard panels for animatics
...
- Combine Image-to-Video with SDXL outputs for unique animated storyboard previews

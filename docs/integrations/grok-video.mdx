...
Apply a Style Preset at the project level to constrain color grade and mood. Grok Video respects style preset instructions when they are applied consistently.

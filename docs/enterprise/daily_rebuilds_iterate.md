...
sidebar_label: "Daily Movie Rebuilds"
...
If your production reviews cuts weekly and wishes it could review daily, the rebuild loop is worth understanding properly. **[Read how ACT 3 builds a full movie from a script](/use-cases/creators/ai_builds_whole)**, or start a production and run your first rebuild cycle.
